...
<header class="site-header" role="banner">
    <div class="header-inner">
        ...
        <a class="logo" href="<?= BASE_URL ?>index.php">MOVIESTREAM</a>

        <nav class="main-nav" role="navigation" aria-label="Primary">
            <a href="<?= BASE_URL ?>index.php"><i class="fa fa-home fa-fw"></i> Home</a>
            <a href="<?= BASE_URL ?>movies/catalog.php?type=movie"><i class="fa fa-film fa-fw"></i> Movies</a>
          <a href="<?= BASE_URL ?>movies/catalog.php?view=trending" class="nav-item">
    <i class="fa fa-fire"></i> Trending
</a>
            <a href="<?= BASE_URL ?>about.php"><i class="fa fa-info-circle fa-fw"></i> About</a>
        </nav>

        <div class="search-area">
            <form action="<?= BASE_URL ?>movies/catalog.php" method="GET" style="display:flex;gap:8px;align-items:center">
        ...
        <div class="user-area">
            <?php if (!empty($_SESSION['user_id'])): ?>
                <a href="<?= BASE_URL ?>users/profile.php" aria-label="Profile"><i class="fa fa-user fa-fw"></i></a>
                <a href="<?= BASE_URL ?>auth/logout.php" aria-label="Logout"><i class="fa fa-sign-out-alt fa-fw"></i></a>
            <?php else: ?>
                <a href="<?= BASE_URL ?>auth/login.php" aria-label="Login">Login</a>
                <a href="<?= BASE_URL ?>auth/register.php" aria-label="Sign up" style="background:var(--accent);color:#fff;padding:8px 10px">Sign Up</a>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="mobile-drawer" id="mobileDrawer" aria-hidden="true">
        ...
        <div class="mobile-links">
            <a href="<?= BASE_URL ?>index.php"><i class="fa fa-home fa-fw"></i> Home</a>
            <a href="<?= BASE_URL ?>movies/catalog.php?type=movie"><i class="fa fa-film fa-fw"></i> Movies</a>
            <a href="<?= BASE_URL ?>movies/catalog.php?type=tv"><i class="fa fa-tv fa-fw"></i> TV Shows</a>
            <a href="<?= BASE_URL ?>movies/catalog.php?sort=most_viewed"><i class="fa fa-fire fa-fw"></i> Trending</a>
            <?php if (!empty($_SESSION['user_id'])): ?>
                <a href="<?= BASE_URL ?>users/profile.php"><i class="fa fa-user fa-fw"></i> Profile</a>
                <a href="<?= BASE_URL ?>auth/logout.php"><i class="fa fa-sign-out-alt fa-fw"></i> Logout</a>
            <?php else: ?>
                <a href="<?= BASE_URL ?>auth/login.php"><i class="fa fa-sign-in-alt fa-fw"></i> Login</a>
                <a href="<?= BASE_URL ?>auth/register.php" style="background:var(--accent);color:#fff;padding:8px;border-radius:8px;text-align:center">Sign Up</a>
            <?php endif; ?>
        </div>
    </div>
